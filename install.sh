...
echo "  /sessions --new \"name\"          — create a new named session"
echo "  /sessions --find \"query\"        — find sessions by name"
echo "  /sessions --delete \"name\"       — delete a session by name"
echo "  /sessions --delete              — delete all unnamed sessions"
echo ""
echo "To uninstall:"
